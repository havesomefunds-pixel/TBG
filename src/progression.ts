...
export const UNLOCKS: Record<number, string[]> = { 0: ['ping', 'profile', 'blackjack', 'slots', 'gamble', 'daily', 'crash', 'vibe', 'ship', '8ball', 'raffle', 'quests', 'bounty', 'tictactoe', 'duel'], 5: ['rob'], 15: ['donate', 'coinflip'], 20: ['give'], 50: ['prestige'] };
